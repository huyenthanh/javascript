...
export default class PostModel {
   ...
   */
  async getAll(params) {
    return await Api.getAll(`${URL_API.POST_URL}?_expand=user&_sort=createdAt&_order=desc`, params);
  }
  ...
  async getComments(id) {
    const url = `${URL_API.POST_URL}/${id}${URL_API.COMMENT_URL}?_expand=user&_sort=createdAt&_order=desc`;
